...
{
    CPluginCplusplusTest* gPlugin = NULL;

    CPluginCplusplusTest::CPluginCplusplusTest()
    {
        gPlugin = this;
    }
    ...
    bool CPluginCplusplusTest::Release( bool bForce )
    {
        bool bRet = true;
    ...
    bool CPluginCplusplusTest::Init( SSystemGlobalEnvironment& env, SSystemInitParams& startupParams, IPluginBase* pPluginManager, const char* sPluginDirectory )
    {
    ...
    bool CPluginCplusplusTest::RegisterTypes( int nFactoryType, bool bUnregister )
    {
    ...
    const char* CPluginCplusplusTest::ListCVars() const
    {
        return "..."; // TODO: Enter CVARs/Commands here if you have some
    }

    const char* CPluginCplusplusTest::GetStatus() const
    {
        return "OK";
    }
