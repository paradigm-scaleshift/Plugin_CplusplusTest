; CplusplusTest Plugin Installer
...
Name "CplusplusTest Plugin ${VERSION} for CryEngine"

; The file to write
OutFile "Plugin_CplusplusTest_${VERSION}.exe"
...
; Sections
Section "CplusplusTest" SEC_PLUGIN
    SectionIn RO
        
    SetOutPath "$INSTDIR\Bin32\Plugins\CplusplusTest"
    ;File "${FILES_ROOT}\..\..\Bin32\Plugins\CplusplusTest\Plugin_CplusplusTest.dll"
	File "${FILES_ROOT}\..\..\Bin32\Plugins\CplusplusTest\*.dll"

    SetOutPath "$INSTDIR\Bin64\Plugins\CplusplusTest"
    ;File "${FILES_ROOT}\..\..\Bin64\Plugins\CplusplusTest\Plugin_CplusplusTest.dll"
    File "${FILES_ROOT}\..\..\Bin64\Plugins\CplusplusTest\*.dll"

	; Standard Code directory also used in git repo
    SetOutPath "$INSTDIR\Code\Plugin_CplusplusTest"
...
Section "Interface Headers" SEC_INTERFACE
    SetOutPath "$INSTDIR\Code\Plugin_CplusplusTest\inc"
...
; Set Fileinfos
VIAddVersionKey /LANG=${LANG_ENGLISH} "ProductName" "CplusplusTest Plugin"
VIAddVersionKey /LANG=${LANG_ENGLISH} "LegalCopyright" "Copyright (c) 2013, The authors of the CplusplusTest Plugin project"
VIAddVersionKey /LANG=${LANG_ENGLISH} "FileDescription" "CplusplusTest Plugin for CryEngine"
...
Function "ShowChangelog"
	Exec 'notepad "$INSTDIR\Code\Plugin_CplusplusTest\changelog.md"'
FunctionEnd
